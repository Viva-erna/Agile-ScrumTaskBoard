...
namespace DMaster.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public void AddCommandViewerForSuper()
        {
            ...
            commandViewer.Name = "Новый пользователь";
        ...
        {
            var request = MessageBox.Show("Вы бы хотели удалить это задание?", "Удаление задания", MessageBoxButton.YesNo);
        ...
        {
            var request = MessageBox.Show("Хотели бы вы изменить статус этой задачи?", "Создание задачи InProgress", MessageBoxButton.YesNo);
            if (request == MessageBoxResult.Yes)
            {
        ...
        {
            var request = MessageBox.Show("Хотите ли вы изменить статус этой задачи?", "Выполнение задачи выполнено", MessageBoxButton.YesNo);
            if (request == MessageBoxResult.Yes)
            {
        ...
        {
            var request = MessageBox.Show("Хотите ли вы изменить статус этой задачи?", "Создание незавершенной задачи", MessageBoxButton.YesNo);
            if (request == MessageBoxResult.Yes)
            {
